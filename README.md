...
- 知识是公共品：函数库与 StyleCool 坚持永久免费开放。
...
- 十大语言常用函数速查，每条带完整可运行代码示例。
- 条目含中英文名称与描述、用途、依赖、标签、输入/返回类型与性能评分。

#### 站内搜索

- 按名称、描述、标签模糊匹配，支持按语言过滤。

#### Skill API

- 为 AI 与自动化工作流提供的结构化检索接口，返回即用的 JSON。
- 永久密钥机制，支持 IP 限流保护。
