...
const i18nTexts = {
    ...
    'results-count-pattern': '为 "${query}" 找到 ${count} 个结果',
        ...
        'stylecool-header-subtitle': '给 AI 与自动化工作流的设计模式 StyleCool — 联网为 AI 注入审美判断力',
        'stylecool-hero-badge': 'AI 设计审美',
        'stylecool-hero-title': '设计模式索引',
        'stylecool-hero-desc': 'AI 模型擅长代码逻辑，但天生缺乏<strong>设计审美</strong>——它们不知道什么是"好看"、什么是"低级感"。<br>StyleCool 联网调用由人类设计师精心筛选的设计模式库，在 AI 动手写 CSS 之前<strong>为它注入品味</strong>：<br>正确的做法、必须避开的坑、平台特定的设计规则。结果不是"能用的 UI"，而是<strong>有审美的 UI</strong>。',
